...
echo com_siteheader('Exodus 2004 Manifest');
...
if(1)
{
    ...
    $setup['Augusta']['depart'] = array('0300','0515','0900','1130','1430','1730');
        ...
        for($x=0;$x<$num;$x++)
        {
            ...
            if($airport=='Atlanta')
            {
                ...
                $query = "CREATE TEMPORARY TABLE temp1 (PRIMARY KEY(id)) SELECT e.id, e.dep_datetime
                          ...
                          e.exodus_status!='Returned' and e.dep_datetime between 20041217060000 AND 20041217235959
    ...
    foreach($_CONF['gate_numbers'] as $gate)
    {
        ...
        $query = "select m.id, m.Rank, m.Last_Name, m.First_Name, m.Middle_Initial as MI, right(m.ssn,4) as SSN,
                  ...
                  and e.dep_datetime BETWEEN 20041217000000 AND 20041217235959 and {$report['where']}
