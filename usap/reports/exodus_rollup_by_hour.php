...
if($unit = $val->unit($_GET['unit'],14))
{
    ...
    echo com_siteheader("Holiday Block Leave Rollup By Hour " . $report['unit'] . " --- $date");
    ...
    if(isset($_REQUEST['Time_Code']))
    {
        ...
        $header =  "<strong>HBL Rollup By Hour ($mode): " . $report["unit"] . " --- $date </strong>";
    ...
    else
    {
        ...
        $header =  "<strong>HBL Air-Atlanta Rollup By Hour ($mode): " . $report["unit"] . " --- $date </strong>";
        ...
        $header =  "<strong>HBL Air-Augusta Rollup By Hour ($mode): " . $report["unit"] . " --- $date </strong>";
...
{
    echo com_siteheader("Invalid permissions - HBL Rollup By Hour");
