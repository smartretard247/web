...
echo com_siteheader('Exodus Manifest'); //set calendar year accordingly
...
if(1)
{
    ...
    $setup['Augusta']['start'] = array('060000','140000','194500');

    //End times of flights for each wave
    $setup['Atlanta']['end'] = array('095959','125959','235959');
    $setup['Augusta']['end'] = array('135959','194459','235959');
