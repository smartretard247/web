...
$_CONF['web'] = 'https://' . $_SERVER['SERVER_NAME'];
...
// to log an error
//$_CONF["log_errors"] = "off";
//*** not implemented ***

//file to log errors to (also used for verbose logging)
$_CONF["error_log"] = "f:/php/error.log";
