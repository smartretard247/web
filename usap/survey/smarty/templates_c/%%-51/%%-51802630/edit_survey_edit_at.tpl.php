<?php /* Smarty version 2.3.0, created on 2004-08-02 12:08:22
...
" size="40" maxlength="255"></td>
              <td><input type="text" name="group_id[<?php echo $this->_tpl_vars['answer']['avid'][$this->_sections['i']['index']]; ?>
]" value="<?php echo $this->_tpl_vars['answer']['group_id'][$this->_sections['i']['index']]; ?>
