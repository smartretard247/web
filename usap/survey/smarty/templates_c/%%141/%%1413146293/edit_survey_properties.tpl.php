...
/docs/index.html#ep_name">[?]</a></div>
      ...
      <div class="indented_cell">
        <input type="text" name="name" value="<?php echo $this->_tpl_vars['property']['name']; ?>
" size="50">
      </div>

      <div class="whitebox">Creation Date: <?php echo $this->_tpl_vars['property']['created']; ?>
</div>
...
/docs/index.html#ep_active">[?]</a></div>
      ...
      <div class="indented_cell">
        <input type="radio" name="active" value="1" <?php echo $this->_tpl_vars['property']['active_selected']; ?>
>Active
        &nbsp;
        <input type="radio" name="active" value="0" <?php echo $this->_tpl_vars['property']['inactive_selected']; ?>
>Inactive
      </div>
...
/docs/index.html#ep_dates">[?]</a></div>
      ...
      <div class="indented_cell">
        ...
        <br />
        <input type="text" name="start" size="11" maxlength="10" value="<?php echo $this->_tpl_vars['property']['start_date']; ?>
"> (yyyy-mm-dd)
      </div>
      ...
      <div class="indented_cell">
        <input type="text" name="end" size="11" maxlength="10" value="<?php echo $this->_tpl_vars['property']['end_date']; ?>
"> (yyyy-mm-dd)
      </div>
...
$this->_sections["tem"]['loop'] = is_array($this->_tpl_vars['property']['templates']) ? count($this->_tpl_vars['property']['templates']) : max(0, (int)$this->_tpl_vars['property']['templates']);
...
?>
            <option value="<?php echo $this->_tpl_vars['property']['templates'][$this->_sections['tem']['index']]; ?>
"<?php echo $this->_tpl_vars['property']['selected_template'][$this->_sections['tem']['index']]; ?>
><?php echo $this->_tpl_vars['property']['templates'][$this->_sections['tem']['index']]; ?>
</option>
          <?php endfor; endif; ?>
        </select>
      </div>
...
$this->_sections["fullhtml_warning"]['show'] = (bool)$this->_tpl_vars['show']['fullhtmlwarning'];
...
$this->_sections["stm"]['loop'] = is_array($this->_tpl_vars['property']['survey_text_mode_options']) ? count($this->_tpl_vars['property']['survey_text_mode_options']) : max(0, (int)$this->_tpl_vars['property']['survey_text_mode_options']);
...
?>
              <option value="<?php echo $this->_tpl_vars['property']['survey_text_mode_options'][$this->_sections['stm']['index']]; ?>
"<?php echo $this->_tpl_vars['property']['survey_text_mode_selected'][$this->_sections['stm']['index']]; ?>
><?php echo $this->_tpl_vars['property']['survey_text_mode_values'][$this->_sections['stm']['index']]; ?>
</option>
            <?php endfor; endif; ?>
          </select>
        <br />
...
$this->_sections["utm"]['loop'] = is_array($this->_tpl_vars['property']['user_text_mode_options']) ? count($this->_tpl_vars['property']['user_text_mode_options']) : max(0, (int)$this->_tpl_vars['property']['user_text_mode_options']);
...
?>
              <option value="<?php echo $this->_tpl_vars['property']['user_text_mode_options'][$this->_sections['utm']['index']]; ?>
"<?php echo $this->_tpl_vars['property']['user_text_mode_selected'][$this->_sections['utm']['index']]; ?>
><?php echo $this->_tpl_vars['property']['user_text_mode_values'][$this->_sections['utm']['index']]; ?>
</option>
            <?php endfor; endif; ?>
          </select>
      </div>
...
/docs/index.html#ep_redirect">[?]</a></div>
      <div class="indented_cell">
        ...
        <input type="radio" name="redirect_page" value="index"<?php echo $this->_tpl_vars['property']['redirect_index']; ?>
> Main Survey Page <span class="example">(index.php)</span><br />
        <input type="radio" name="redirect_page" value="results"<?php echo $this->_tpl_vars['property']['redirect_results']; ?>
> Survey Results Page <span class="example">(Results Access should be Public)</span><br />
        <input type="radio" name="redirect_page" value="custom"<?php echo $this->_tpl_vars['property']['redirect_custom']; ?>
> Custom URL <span class="example">(Provide complete URL including http:// or https://)</span><br />
        <div style="margin-left:20px">
          URL: <input type="text" name="redirect_page_text" value="<?php echo $this->_tpl_vars['property']['redirect_page_text']; ?>
" size="30" maxlength="255">
        </div>
      </div>

      <div class="whitebox">Survey Access <a href="<?php echo $this->_tpl_vars['conf']['html']; ?>
/docs/index.html#ep_access">[?]</a></div>

      <div class="indented_cell">
        <input type="radio" name="survey_access" value="public" <?php echo $this->_tpl_vars['property']['survey_public']; ?>
>Public (Anyone can take survey)
        <br>
        <input type="radio" name="survey_access" value="private" <?php echo $this->_tpl_vars['property']['survey_private']; ?>
>Private
        &nbsp;
        Password: <input type="text" name="survey_password" value="<?php echo $this->_tpl_vars['property']['survey_password']; ?>
">
      </div>
      ...
      <div class="indented_cell">
        <input type="radio" name="results_access" value="public" <?php echo $this->_tpl_vars['property']['results_public']; ?>
>Public (Anyone can view results)
        <br>
        <input type="radio" name="results_access" value="private" <?php echo $this->_tpl_vars['property']['results_private']; ?>
>Private
        &nbsp;
        Password: <input type="text" name="results_password" value="<?php echo $this->_tpl_vars['property']['results_password']; ?>
">
      </div>

      <div class="whitebox">Edit Password <a href="<?php echo $this->_tpl_vars['conf']['html']; ?>
/docs/index.html#ep_password">[?]</a></div>

      <div class="indented_cell">
        <input type="text" name="edit_password" value="<?php echo $this->_tpl_vars['property']['edit_password']; ?>
">
      </div>
...
/docs/index.html#ep_results_date_format">[?]</a></div>
      ...
      <div class="indented_cell">
        ...
        <input type="text" name="date_format" size="20" value="<?php echo $this->_tpl_vars['property']['date_format']; ?>
">
      </div>
...
/docs/index.html#ep_time_limit">[?]</a></div>
      ...
      <div class="indented_cell">
        ...
        are saved.<br />
        <input type="text" name="time_limit" size="5" value="<?php echo $this->_tpl_vars['property']['time_limit']; ?>
"> (minutes)
      </div>
