<?php /* Smarty version 2.3.0, created on 2004-08-02 12:07:38
         compiled from Default/edit_survey_questions.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'cycle', 'Default/edit_survey_questions.tpl', 21, false),)); ?>        <table border="1" width="95%" cellspacing="0" cellpadding="0" align="center">
...
$this->_sections["p"]['loop'] = is_array($this->_tpl_vars['property']['qid']) ? count($this->_tpl_vars['property']['qid']) : max(0, (int)$this->_tpl_vars['property']['qid']);
...
/edit_survey.php">
            <input type="hidden" name="mode" value="<?php echo $this->_tpl_vars['mode']['questions']; ?>
">
            <input type="hidden" name="sid" value="<?php echo $this->_tpl_vars['property']['sid']; ?>
">
            <tr bgcolor="<?php $this->_plugins['function']['cycle'][0](array('values' => "#F9F9F9,#FFFFFF"), $this); if($this->_extract) { extract($this->_tpl_vars); $this->_extract=false; } ?>">
              <td style="text-align:center;">
                <?php echo $this->_tpl_vars['property']['qnum'][$this->_sections['p']['index']]; ?>

                <input type="hidden" name="qid" value="<?php echo $this->_tpl_vars['property']['qid'][$this->_sections['p']['index']]; ?>
">
              </td>
              <td>
                <div class="indented_cell">
                  <?php echo $this->_tpl_vars['property']['question'][$this->_sections['p']['index']]; ?>
...
$this->_sections["show_edep"]['show'] = (bool)$this->_tpl_vars['property']['show_edep'][$this->_sections['p']['index']];
...
$this->_sections["dep"]['loop'] = is_array($this->_tpl_vars['property']['edep_option'][$this->_sections['p']['index']]) ? count($this->_tpl_vars['property']['edep_option'][$this->_sections['p']['index']]) : max(0, (int)$this->_tpl_vars['property']['edep_option'][$this->_sections['p']['index']]);
$this->_sections["dep"]['show'] = (bool)$this->_tpl_vars['property']['edep_option'][$this->_sections['p']['index']];
...
?>
                    <div style="margin-left:5%;">
                      &bull; <?php echo $this->_tpl_vars['property']['edep_option'][$this->_sections['p']['index']][$this->_sections['dep']['index']]; ?>
 if question <?php echo $this->_tpl_vars['property']['edep_qnum'][$this->_sections['p']['index']][$this->_sections['dep']['index']]; ?>

                      is: <?php echo $this->_tpl_vars['property']['edep_value'][$this->_sections['p']['index']][$this->_sections['dep']['index']]; ?>
...
$this->_sections["options"]['show'] = (bool)$this->_tpl_vars['property']['page_break'][$this->_sections['p']['index']];
...
?>
                ...
                <?php endfor; else: ?>
                  <td style="text-align:center;" width="15%">
                    <input type="checkbox" name="del_qid" value="<?php echo $this->_tpl_vars['property']['qid'][$this->_sections['p']['index']]; ?>
">
                    <input type="submit" name="delete_question" value="Delete">
                  </td>
...
/edit_survey.php" name="qform">
        <input type="hidden" name="mode" value="<?php echo $this->_tpl_vars['mode']['new_question']; ?>
">
        <input type="hidden" name="sid" value="<?php echo $this->_tpl_vars['property']['sid']; ?>
">
...
$this->_sections["answer"]['loop'] = is_array($this->_tpl_vars['answer']) ? count($this->_tpl_vars['answer']) : max(0, (int)$this->_tpl_vars['answer']);
...
?>
              <option value="<?php echo $this->_tpl_vars['answer'][$this->_sections['answer']['index']]['aid']; ?>
"<?php echo $this->_tpl_vars['answer'][$this->_sections['answer']['index']]['selected']; ?>
><?php echo $this->_tpl_vars['answer'][$this->_sections['answer']['index']]['name']; ?>
</option>
            <?php endfor; endif; ?>
          </select>
          &nbsp;
          <a href="#show_answers" onclick="window.open('display_answers.php?sid=<?php echo $this->_tpl_vars['property']['sid']; ?>
...
$this->_sections["num_answers"]['loop'] = is_array($this->_tpl_vars['num_answers']) ? count($this->_tpl_vars['num_answers']) : max(0, (int)$this->_tpl_vars['num_answers']);
...
?>
              <option value="<?php echo $this->_tpl_vars['num_answers'][$this->_sections['num_answers']['index']]; ?>
"<?php echo $this->_tpl_vars['num_answers_selected'][$this->_sections['num_answers']['index']]; ?>
><?php echo $this->_tpl_vars['num_answers'][$this->_sections['num_answers']['index']]; ?>
</option>
            <?php endfor; endif; ?>
          </select>
        </div>
...
$this->_sections["num_required"]['loop'] = is_array($this->_tpl_vars['num_required']) ? count($this->_tpl_vars['num_required']) : max(0, (int)$this->_tpl_vars['num_required']);
...
?>
              <option value="<?php echo $this->_tpl_vars['num_required'][$this->_sections['num_required']['index']]; ?>
"<?php echo $this->_tpl_vars['num_required_selected'][$this->_sections['num_required']['index']]; ?>
><?php echo $this->_tpl_vars['num_required'][$this->_sections['num_required']['index']]; ?>
</option>
            <?php endfor; endif; ?>
          </select>
        </div>
...
$this->_sections["qnum"]['loop'] = is_array($this->_tpl_vars['property']['qnum2']) ? count($this->_tpl_vars['property']['qnum2']) : max(0, (int)$this->_tpl_vars['property']['qnum2']);
...
?>
              <option value="<?php echo $this->_tpl_vars['property']['page_oid'][$this->_sections['qnum']['index']]; ?>
"<?php echo $this->_tpl_vars['property']['qnum2_selected'][$this->_sections['qnum']['index']]; ?>
><?php echo $this->_tpl_vars['property']['qnum2'][$this->_sections['qnum']['index']]; ?>
</option>
            <?php endfor; endif; ?>
          </select>
        </div>
...
"<?php echo $this->_tpl_vars['property']['orientation']['selected'][$this->_sections['orient']['index']]; ?>
...
$this->_sections["dependencies"]['show'] = (bool)$this->_tpl_vars['show']['dep'];
...
$this->_sections["dep_qid"]['loop'] = is_array($this->_tpl_vars['property']['dep_qid']) ? count($this->_tpl_vars['property']['dep_qid']) : max(0, (int)$this->_tpl_vars['property']['dep_qid']);
...
?>
                  <option value="<?php echo $this->_tpl_vars['property']['dep_qid'][$this->_sections['dep_qid']['index']]; ?>
"><?php echo $this->_tpl_vars['property']['dep_qnum'][$this->_sections['dep_qid']['index']]; ?>
</option>
                <?php endfor; endif; ?>
              </select>
              is answered with
              ...
              <script language="javascript">
                ...
                <?php echo $this->_tpl_vars['property']['js']; ?>
