<?php /* Smarty version 2.3.0, created on 2004-08-02 12:07:06
...
?>
            ...
            <?php if (isset($this->_sections["show_group_answers"])) unset($this->_sections["show_group_answers"]);
$this->_sections["show_group_answers"]['name'] = "show_group_answers";
$this->_sections["show_group_answers"]['loop'] = is_array("1") ? count("1") : max(0, (int)"1");
$this->_sections["show_group_answers"]['show'] = (bool)$this->_tpl_vars['survey']['show_group_answers'];
$this->_sections["show_group_answers"]['max'] = $this->_sections["show_group_answers"]['loop'];
$this->_sections["show_group_answers"]['step'] = 1;
$this->_sections["show_group_answers"]['start'] = $this->_sections["show_group_answers"]['step'] > 0 ? 0 : $this->_sections["show_group_answers"]['loop']-1;
if ($this->_sections["show_group_answers"]['show']) {
    $this->_sections["show_group_answers"]['total'] = $this->_sections["show_group_answers"]['loop'];
    if ($this->_sections["show_group_answers"]['total'] == 0)
        $this->_sections["show_group_answers"]['show'] = false;
} else
    $this->_sections["show_group_answers"]['total'] = 0;
if ($this->_sections["show_group_answers"]['show']):

            for ($this->_sections["show_group_answers"]['index'] = $this->_sections["show_group_answers"]['start'], $this->_sections["show_group_answers"]['iteration'] = 1;
                 $this->_sections["show_group_answers"]['iteration'] <= $this->_sections["show_group_answers"]['total'];
                 $this->_sections["show_group_answers"]['index'] += $this->_sections["show_group_answers"]['step'], $this->_sections["show_group_answers"]['iteration']++):
$this->_sections["show_group_answers"]['rownum'] = $this->_sections["show_group_answers"]['iteration'];
$this->_sections["show_group_answers"]['index_prev'] = $this->_sections["show_group_answers"]['index'] - $this->_sections["show_group_answers"]['step'];
$this->_sections["show_group_answers"]['index_next'] = $this->_sections["show_group_answers"]['index'] + $this->_sections["show_group_answers"]['step'];
$this->_sections["show_group_answers"]['first']      = ($this->_sections["show_group_answers"]['iteration'] == 1);
$this->_sections["show_group_answers"]['last']       = ($this->_sections["show_group_answers"]['iteration'] == $this->_sections["show_group_answers"]['total']);
?>
              <option value="group_answers">Group Answers</option>
            <?php endfor; endif; ?>

            <?php if (isset($this->_sections["show_ungroup_answers"])) unset($this->_sections["show_ungroup_answers"]);
$this->_sections["show_ungroup_answers"]['name'] = "show_ungroup_answers";
$this->_sections["show_ungroup_answers"]['loop'] = is_array("1") ? count("1") : max(0, (int)"1");
$this->_sections["show_ungroup_answers"]['show'] = (bool)$this->_tpl_vars['survey']['show_ungroup_answers'];
$this->_sections["show_ungroup_answers"]['max'] = $this->_sections["show_ungroup_answers"]['loop'];
$this->_sections["show_ungroup_answers"]['step'] = 1;
$this->_sections["show_ungroup_answers"]['start'] = $this->_sections["show_ungroup_answers"]['step'] > 0 ? 0 : $this->_sections["show_ungroup_answers"]['loop']-1;
if ($this->_sections["show_ungroup_answers"]['show']) {
    $this->_sections["show_ungroup_answers"]['total'] = $this->_sections["show_ungroup_answers"]['loop'];
    if ($this->_sections["show_ungroup_answers"]['total'] == 0)
        $this->_sections["show_ungroup_answers"]['show'] = false;
} else
    $this->_sections["show_ungroup_answers"]['total'] = 0;
if ($this->_sections["show_ungroup_answers"]['show']):

            for ($this->_sections["show_ungroup_answers"]['index'] = $this->_sections["show_ungroup_answers"]['start'], $this->_sections["show_ungroup_answers"]['iteration'] = 1;
                 $this->_sections["show_ungroup_answers"]['iteration'] <= $this->_sections["show_ungroup_answers"]['total'];
                 $this->_sections["show_ungroup_answers"]['index'] += $this->_sections["show_ungroup_answers"]['step'], $this->_sections["show_ungroup_answers"]['iteration']++):
$this->_sections["show_ungroup_answers"]['rownum'] = $this->_sections["show_ungroup_answers"]['iteration'];
$this->_sections["show_ungroup_answers"]['index_prev'] = $this->_sections["show_ungroup_answers"]['index'] - $this->_sections["show_ungroup_answers"]['step'];
$this->_sections["show_ungroup_answers"]['index_next'] = $this->_sections["show_ungroup_answers"]['index'] + $this->_sections["show_ungroup_answers"]['step'];
$this->_sections["show_ungroup_answers"]['first']      = ($this->_sections["show_ungroup_answers"]['iteration'] == 1);
$this->_sections["show_ungroup_answers"]['last']       = ($this->_sections["show_ungroup_answers"]['iteration'] == $this->_sections["show_ungroup_answers"]['total']);
?>
