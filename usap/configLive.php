...
$_CONF['web'] = 'http://' . $_SERVER['SERVER_NAME'];
$_CONF['html'] = $_CONF['web'];
$_CONF['current_page'] = 'http://' . $_SERVER['SERVER_NAME'] . $_SERVER['SCRIPT_NAME'];
...
$_CONF["db_host"] = "usap.gordon.army.mil";
$_CONF["db_user"] = "export";
$_CONF["db_password"] = "export";
$_CONF["db_name"] = "USAP";
...
$_CONF["platoon"] = array("HQ","1","2","3","4","5","MED","INACT");
$_CONF["yn"] = array("Y","N");
$_CONF["dental_category"] = array('1','2','3','4');
$_CONF["shift"] = array("None","Day","Swing","Mid");
...
$_CONF['race'] = array('Asian Pacific','Black','Hispanic','Other','White');
...
$_CONF["mos"] = array("00Z","01A","01C","15A","24A","25A","25B","25C","25F", "25L", "25M","25P", "25Q", "25S", "25T", "25V","25R","25Z","27D","31C","31F","31L","31P","31R","31S","31T","31U","31W","31Z",
...
$_CONF['religion'] = array("7th Day Adventist","Baptist","Buddhism","Christian","Episcopal","Greek Orthodox","Hindu",
                            "Jehovah Witness","Jewish","Lutheran","Methodist","Mormon / Latter Day Saints","Muslim / Islam",
...
$_CONF['exodus_edit_off'] = '18DEC06 13:00:00';
//id numbers of personnel allowed to edit exodus records
//after the edit ability has been turned off
$_CONF['exodus_edit_allowed'] = array(37446); 
//DAN GRAY

//date of exodus
$_CONF['exodus_date'] = '19DEC2006';
//date that people return from exodus
$_CONF['exodus_end'] = "02JAN2007";
//datetime that people returning before
//will be considered "returning early"
//Format: YYYYMMDDHHMMSS
$_CONF['exodus_return_early'] = "20070102000000";

//date people leave for 3K
$_CONF['three_kings_start'] = "07JAN2007";
//date people return from 3K
$_CONF['three_kings_end'] = "07JAN2007";

//date to start/end collecting exodus data
$_CONF['exodus_data_start'] = "01NOV2006";
$_CONF['exodus_data_end'] = "10JAN2007";

$_CONF['exodus_modes'] = array("POV","BUS","AIR");
...
$_CONF['exodus_airports'] = array("Atlanta","Augusta");
...
$errormsg[0] = "You have entered an invalid login or password. passwords are case sensitive. Please enter login information again.";
