<?php /* Smarty version 2.3.0, created on 2004-01-29 13:11:57
         compiled from edit_group_tda.tpl */ ?>
...
">
            ...
            <td align="center"><?php echo $this->_tpl_vars['display']['tda_assigned_select'][$this->_sections['r']['index']]; ?>
</td>
            <td align="center"><?php echo $this->_tpl_vars['display']['tda_working_select'][$this->_sections['r']['index']]; ?>
</td>
            <td align="center"><?php echo $this->_tpl_vars['display']['comment'][$this->_sections['r']['index']]; ?>
</td>
          </tr>
          <?php endfor; endif; ?>
        </table>